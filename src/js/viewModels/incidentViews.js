...
define(['ojs/ojcore', 'knockout', 'jquery', 'appController', 'ojs/ojknockout'], function(oj, ko, $, app) {
  function viewModel(params) {
    ...
    self.handleDetached = function() {
      console.log("incident view handleDetached");
    }

    self.dispose = function() {
      console.log("incident view dispose");
    }
    ...
    self.goToCustomer = function(custId, incidentId) {
      ...
      // This allows the customer page header to be on top and the padding calculation and animation
      // for customer page will be correct.
      document.getElementById('topDiv').classList.remove('oj-applayout-fixed-top');
      document.getElementById('topDiv').setAttribute('style', 'width:100%');
    }
